...
if( ! function_exists( 'avia_append_burger_menu' ) )
{
	...
	function avia_append_burger_menu ( $items , $args )
	{
	    ...
	    if( ( is_object( $args ) && ( $location == 'avia' ) ) || ( is_string( $args ) && ( $args == 'fallback_menu' ) ) )
	    {
	        ...
	        $items .= '<li class="av-burger-menu-main menu-item-avia-special ' . $class . '" role="menuitem">
...
if( ! function_exists( 'avia_post_nav' ) )
{
	...
	function avia_post_nav( $same_category = false, $taxonomy = 'category' )
	{
		...
		if( ( class_exists( 'avia_sc_layerslider', false ) && ! empty( avia_sc_layerslider::$slide_count ) ) ||
			( class_exists( 'avia_sc_slider_full', false ) && ! empty( avia_sc_slider_full::$slide_count ) )  )
		{
...
if( ! function_exists( 'avia_active_caching' ) )
{
	...
	{
		if( defined( 'W3TC' ) || defined( 'WPCACHEHOME' ) || class_exists( 'HyperCache', false ) || class_exists( '\\quick_cache\\plugin', false ) )
		{
			return true;
		}
