...
if( ! class_exists( 'avia_sc_testimonial', false ) )
{
...
//			}
		...
		public function av_testimonial_single( $atts, $content = '', $shortcodename = '' )
		{
			...
			if( $link )
			{
				 ...
				 * @return string
				 */
				$target = apply_filters( 'avf_testimonial_single_target', 'target="_blank"', $atts );
				 ...
				 * @return string
				 */
				$rel = apply_filters( 'avf_testimonial_single_rel', 'rel="noopener noreferrer"', $atts );

				$output .= 				"<a class='avia-testimonial-link' href='{$link}' {$target} {$rel}>{$linktext}</a>";
			}
